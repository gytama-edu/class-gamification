...
CREATE INDEX student_achievements_class_id_idx ON public.student_achievements(class_id);
CREATE INDEX student_achievements_earned_at_idx ON public.student_achievements(earned_at);
CREATE INDEX achievement_definitions_key_idx ON public.achievement_definitions(key);
