    ...
    <div className="min-h-screen bg-cosmic-navy flex flex-col font-sans p-8 relative overflow-hidden">
      ...
      <main className="relative z-10 flex-1 grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-5 flex flex-col justify-end pb-8">
          <h2 className="text-3xl font-bold text-white mb-10 text-center tracking-widest uppercase text-slate-500">
            Top Explorers
          </h2>
            ...
            {topThree[1] && (
              <div className="w-1/3 flex flex-col items-center">
                <div className="bg-slate-800 border-2 border-slate-400 rounded-2xl p-4 w-full mb-4 shadow-xl text-center relative">
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-slate-400 text-slate-900 w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl border-4 border-slate-800">
                    2
                  </div>
                  <h3 className="text-xl font-bold text-white mt-4 truncate">
                    {topThree[1].display_name}
                  </h3>
                  <p className="text-2xl font-mono font-bold text-cosmic-cyan mt-2">
            ...
            {topThree[0] && (
              <div className="w-1/3 flex flex-col items-center z-10">
                <div className="bg-slate-800 border-2 border-amber-400 rounded-2xl p-5 w-full mb-4 shadow-2xl shadow-amber-500/20 text-center relative scale-110">
                  <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-amber-400 text-amber-900 w-16 h-16 rounded-full flex items-center justify-center font-bold text-3xl border-4 border-slate-800 shadow-lg shadow-amber-500/40">
                    1
                  </div>
            ...
            {topThree[2] && (
              <div className="w-1/3 flex flex-col items-center">
                <div className="bg-slate-800 border-2 border-amber-700 rounded-2xl p-4 w-full mb-4 shadow-xl text-center relative">
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-amber-700 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl border-4 border-slate-800">
                    3
                  </div>
                  <h3 className="text-xl font-bold text-white mt-4 truncate">
              ...
              {rest.map((student, index) => (
                ...
                >
                  ...
                  <td className="py-5">
                    <div className="flex justify-center items-center gap-1">
                      ...
                      {student.lives_remaining > 5 && (
                        <span className="text-xl font-bold text-rose-500 ml-2">
                          +{student.lives_remaining - 5}
                        </span>
                      )}
                    </div>
                  ...
                  <td className="py-5 text-right">
                    <span className="text-3xl font-mono font-bold text-cosmic-cyan">
